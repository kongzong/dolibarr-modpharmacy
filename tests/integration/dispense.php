...
try {
	...
	pxTestQuery($db, 'CREATE TABLE '.MAIN_DB_PREFIX.'entrepot (rowid INTEGER AUTO_INCREMENT PRIMARY KEY, entity INTEGER NOT NULL DEFAULT 1, lieu VARCHAR(64), label VARCHAR(255), statut SMALLINT DEFAULT 1) ENGINE=InnoDB');
	...
	pxTestQuery($db, 'INSERT INTO '.MAIN_DB_PREFIX.'entrepot (rowid, entity, lieu, label, statut) VALUES (1, 1, "药房", "main", 1)');
